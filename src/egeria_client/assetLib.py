...
def get_asset_universe(serverName, serverPlatformName, serverPlatformURL, serviceURLMarker, userId,
                       requestType) -> json:
...
def print_asset_comments(serverName, serverPlatformName, serverPlatformURL, serviceURLMarker, userId, asset_guid):
    ...
    commentQuery = connectedAssetURL + '/assets/' + asset_guid + '/comments?elementStart=0&maxElements=50'
...
def print_asset_comment_replies(serverName, serverPlatformName, serverPlatformURL, serviceURLMarker, userId,
                                requestType, commentGUID):
    connectedAssetURL = serverPlatformURL + '/servers/' + serverName + '/open-metadata/common-services/' + serviceURLMarker + '/connected-asset/users/' + userId
...
def print_asset_universe(serverName, serverPlatformName, serverPlatformURL, serviceURLMarker, userId, asset_guid):
    connectedAssetURL = serverPlatformURL + '/servers/' + serverName + '/open-metadata/common-services/' + serviceURLMarker + '/connected-asset/users/' + userId
    getAsset = connectedAssetURL + '/assets/' + asset_guid
    print(" ")
    print("GET " + getAsset)
    #    response = requests.get(getAsset, verify=False)
    response = issue_get(getAsset)
    print("Returns:")
...
def print_related_assets(serverName, serverPlatformName, serverPlatformURL, serviceURLMarker, userId, requestType):
    connectedAssetURL = serverPlatformURL + '/servers/' + serverName + '/open-metadata/common-services/' + serviceURLMarker + '/connected-asset/users/' + userId
    getRelatedAsset = connectedAssetURL + '/assets/' + requestType + '/related-assets?elementStart=0&maxElements=50'
    print(" ")
...
def get_schema_attributes_from_schema_type(serverName, serverPlatformName, serverPlatformURL, serviceURLMarker, userId,
    ...
    if schemaAttributes:
        ...
        process_error_response(serverName, serverPlatformName, serverPlatformURL, response)
